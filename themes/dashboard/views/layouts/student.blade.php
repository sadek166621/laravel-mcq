...
<div class="wrapper">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{ url('/') }}" role="button">
          <i class="fa fa-home"> Visit Website </i>
        </a>
      </li>
  ...
  <footer class="main-footer">
    ...
    All rights reserved. --}}
    <strong>© 2024 | All Rights Reserved | MyTeachersBD | Developed & Maintenance by <a href="https://skydreamit.com/">Sky Dream IT</a></strong>
