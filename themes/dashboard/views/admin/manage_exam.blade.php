                ...
                <div class="row">
                    ...
                    {{-- <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="class_id">
                                ...
                                <option value="{{ $class->class_id}}">{{ $class->teachercls->class_name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div> --}}
                    {{-- <input type="hidden" value="{{ $teacher }}" name="teacher_id"> --}}
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="subject_id">
                                ...
                                <option value="{{ $sub->subject->id}}">{{ $sub->subject->class->class_name }}-{{ $sub->subject->subject_name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="time" required="required" name="exam_time"  class="form-control">
                        </div>
                    </div>
                    <div class="col-sm-12">
                      <div class="form-group">
