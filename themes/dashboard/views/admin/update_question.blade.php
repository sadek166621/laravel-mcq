          ...
          <div class="row">
            <div class="col-12">
              ...
              <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ url('/teacher/edit_question_inner')}}" method="Post" class="" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-sm-12">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <img src="{{ asset('assets') }}/images/uploads/qustion_image/{{$q[0]['image']}}" alt="image" width="100px" height="100px">
