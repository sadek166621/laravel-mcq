                        ...
                        <tbody>
                           @foreach ($portal as $key=>$p )
                               <tr>
                                   ...
                                   <td>
                                       <a href="{{ url('teacher/edit_portal/'.$p['id'])}}" class="btn btn-primary">Edit</a>
                                       <a href="{{ url('teacher/delete_portal/'.$p['id'])}}" class="btn btn-danger">Delete</a>
                                   </td>
                               </tr>
                           @endforeach
                        </tbody>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="{{ url('/teacher/add_new_portal')}}" class="database_operation">
                <div class="row">
                    <div class="col-sm-12">
