                    ...
                    <form action="{{ url('/teacher/edit_exam_sub')}}" class="database_operation container">
                        <div class="row">
                            ...
                            {{-- <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="class_id">
                                        ...
                                        <option value="{{ $class->class_id}}" {{ $exam->class_id ==  $class->class_id ? 'selected': ' ' }} >{{ $class->teachercls->class_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div> --}}
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="subject_id" required>
                                        ...
                                        <option value="{{ $sub->subject->id }}" {{ $exam->subject_id ==  $sub->subject->id ? 'selected': ' ' }}>{{ $sub->subject->class->class_name }}-{{ $sub->subject->subject_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label for="">Enter Date</label>
                                    <input type="time" required="required"  value="{{ $exam->exam_time}}" name="exam_time"  class="form-control">
                                </div>
                            </div>
                            <div class="col-sm-12">
                              <div class="form-group">
