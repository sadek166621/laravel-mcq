    ...
    <div class="container">
        <div class="row g-5">
            ...
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                ...
                <h1 class="mb-4">Welcome to myTEACHERS</h1>
...
<!-- Categories Start -->
<div class="container-xxl py-5 category d-none">
    <div class="container">
...
<div class="container-xxl py-5">
    <div class="container">
        <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
            ...
            <h1 class="mb-5">Featured Subjects</h1>
        </div>
        ...
        <div class="owl-carousel testimonial-carousel position-relative">
            <div class="course-item bg-light">
                ...
                <div class="text-center p-4 pb-0">
                    <h3 class="mb-0">BDT 149.00 / Month</h3>
                    <div class="mb-3">
                        <small class="fa fa-star text-primary"></small>
                        <small class="fa fa-star text-primary"></small>
                        <small class="fa fa-star text-primary"></small>
...
<div class="container-xxl py-5">
    <div class="container">
        ...
        <div class="owl-carousel testimonial-carousel position-relative notes-slider">
        ...
        <div class="row">
            <div class="col-xl-6 col-lg-6  wow slideInLeft" data-wow-delay="100ms" data-wow-duration="2500ms">
                <div class="feature-one__single">
                    <div class="feature-one__single-bg" style="background-image: url({{ asset('frontend') }}/img/feature-one-shape-1.png);">
                    </div>
                    <div class="feature-one__top">
                        <div class="feature-one__top-inner">
                            ...
                            <div class="feature-one__top-title-box">
                                <h3 class="feature-one__top-title"><a href="#">Register your <br>
                                        batch now</a></h3>
                            </div>
                        </div>
                    </div>
                ...
                <div class="feature-one__single feature-one__single--two">
                    ...
                    <div class="feature-one__top">
                        <div class="feature-one__top-inner">
                            ...
                            <div class="feature-one__top-title-box">
                                <h3 class="feature-one__top-title"><a href="#">Join as a <br>
                                        Teacher</a></h3>
                            </div>
                        </div>
                    </div>
